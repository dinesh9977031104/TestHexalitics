...
public class AdapterAsGrid extends RecyclerView.Adapter<AdapterAsGrid.ViewHolder> {

    private List<DataModel> list;
    private Context context;

    public AdapterAsGrid(Context context, List<DataModel> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.row_grid_layout, parent, false);
